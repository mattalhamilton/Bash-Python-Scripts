...
#Check for the subdirectory Mod08Tutorial
dircheck=~/Mod08Tutorial
if ! [[ -d $dircheck ]];then
	mkdir ~/Mod08Tutorial
fi
...
echo "Name,Address,City" > ~/Mod08Tutorial/employee.csv #destructive on purpose

#Write the employee data out to employee.csv in the Mod08Tutorial directory
...
${employee_array[$(($i+1))]},\
${employee_array[$(($i+2))]}"
	echo $line_out >> ~/Mod08Tutorial/employee.csv
...
input=~/Mod08Tutorial/employee.csv
...
#Pack up employee_data.csv into the Mod08Tutorial directory
