...
RandoInser () {
	...
	myArray=(${myArray[*]:0:$indexPosition} "$i" ${myArray[*]:$indexPosition})
}
...
echo -e "Task 1 \n"
echo "Create an array fulled with 10 items"
echo -e "Be sure to get a mix of floating point numbers, integers and text\n"
inputCounter=0
while [[ $inputCounter -lt 10 ]];
do
	read -p "Please enter a number or word for index position $inputCounter: "
userInput
